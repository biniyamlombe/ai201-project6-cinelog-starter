...
class NotInWatchlistError(Exception):
    """Raised when trying to remove or update a film that isn't on the watchlist."""
    pass
...
def set_watchlist_visibility(user_id, film_id, public):
    """
    Set whether a watchlist entry is public.

    Args:
        user_id (str): UUID of the user.
        film_id (str): UUID of the film.
        public (bool): Desired visibility. Defaults for new entries remain True
            at the model level; this updates an existing entry.
